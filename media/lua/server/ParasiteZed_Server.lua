...
function Recipe.OnCreate.TakeAntiParasitics (items, result, player, selectedItem)
    if selectedItem:getFullType() == "Base.ParasiteZed_AntiParasitic"
        player:getModData()['ParasiteInfectionImmune'] =
    end
end ]]
-----------------------            ---------------------------
...
Commands.ParasiteZed.KnockDown = function(player, args)
    local playerId = player:getOnlineID();
...
Commands.ParasiteZed.isParasiteQueenPl = function(player, args)
    local playerId = player:getOnlineID();
    sendServerCommand('ParasiteZed', 'isParasiteQueenPl', {id = playerId, isParasiteQueenPl =  args.isParasiteQueenPl})
end

Commands.ParasiteZed.Injury = function(player, args)
    local playerId = player:getOnlineID();
    sendServerCommand('ParasiteZed', 'Injury', {id = playerId, targID = args.targID})
end


Commands.ParasiteZed.doDespawn = function(player, args)
    local zed = ParasiteZed.findzedID(tonumber(args.zedID))
    if zed then
        zed:removeFromWorld();
